...
- `architecture_type` (string) - Architecture of virtual machine

- `firmware_type` (string) - Firmware Type of virtual machine
...
- `seed_from` (string) - This is uri that points to a cloud-init source via file:// http:// or https:// it should
